...
def train_agent(rounds=25000, use_score=True, name='result_dir', create_agent=create_ddqn_agent):
...
if __name__ == '__main__':
    agent_score = train_agent( rounds=25000, use_score=True, name='models/acer_score_chainer', create_agent=create_acer_agent) # allow agent to see scores
    # models are automatically saved

    #agent_blackbox = train_agent( rounds=10000, use_score=False, name='models/acer_chainer', create_agent=create_acer_agent) # black blox
    # models are automatically saved
